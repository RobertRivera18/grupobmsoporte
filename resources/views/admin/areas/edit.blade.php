<x-admin-layout :breadcrumbs="[
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-500 mt-1">Complete los datos para actualizar un  departamento dentro del sistema.</p>
        </div>
        <form action="{{ route('admin.areas.update', $area) }}" method="POST"
            ...
            <div class="space-y-2">
                ...
                <x-input
                    ...
                    type="text" name="nombre" value="{{ $area->nombre }}" placeholder="Ej. Recursos Humanos"
                    required />
            </div>
